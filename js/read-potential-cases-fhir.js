...
(async () => {
  ...
  await fs.writeFile("antihypertensive-drugs-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("antihypertensive-drugs-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
